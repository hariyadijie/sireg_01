  ...
  <div class="col-xs-12 col-md-6">
    <div class="box">
      <div class="box-header bg-olive">
        <h3 class="box-title"> Detail Hasil Cetak Akte Kematian <strong><?php echo $nama_lengkap; ?></strong></h3>
      ...
      <div class="box-body">
        <table class="table table-responsive table-hover">
          ...
          <tr>
            <td>Nomor Akte Kematian</td>
            <td><?php echo $no_aktemati; ?></td>
          </tr>
          <tr>
            <td>Tanggal Cetak</td>
          ...
          <tr>
            <td><a href="<?php echo site_url('hasilcetakaktemati') ?>" class="btn bg-red">Batal</a></td>
          </tr>
        </table>
      </div>
    </div>
