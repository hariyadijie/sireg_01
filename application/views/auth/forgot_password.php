...
<body class="hold-transition login-page" style="height: 100%;overflow: hidden;">
    ...
    <div class="col-md-4 col-xs-12 kanan">
        ...
        <div class="container-login ">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <a href="login" class="a">Kembali ke Halaman Login</a><br />
                </div>
                <div class="col-xs-4">
                    <input type="submit" class="btn bg-purple btn-block" id="loginBtn"
                        value="<?php echo lang('forgot_password_submit_btn') ?>" />
                </div><!-- /.col -->
            </div>
            <?php echo form_close();?>
        </div>
