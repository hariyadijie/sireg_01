...
<body class="hold-transition login-page" style="height: 100%;overflow: hidden;">
    ...
    <div class="col-md-4 col-xs-12 kanan">
        <div class="login-logo">
            <h1><img src="<?= base_url('assets'); ?> /dist/img/LOGO.png"> SIREG DISDUKCAPIL</a></h1>
            <h5><strong>Sistim Informasi Resepsionis dan Registrasi <br>DISDUKCAPIL Kabupaten Bantaeng</strong></h5>
        </div>
