...
<body class="hold-transition login-page" style="height: 100%;overflow: hidden;">
    ...
    <div class="col-md-4 col-xs-12 kanan">
        <div class="login-logo">
            <h1><img src="<?= base_url('assets'); ?> /dist/img/loginLOGO.png" class="logo"> SIREG DISDUKCAPIL</a></h1>
            <h5 class="h5"><strong>Sistim Informasi Resepsionis dan Registrasi <br>DISDUKCAPIL Kabupaten
                    Bantaeng</strong></h5>
        </div>
        <div class="container-login ">
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" name="identity" class="form-control"
                    placeholder="<?php echo lang('login_identity_label') ?>" autofocus />
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <label><?php echo lang('login_password_label') ?></label>
                <input type="password" id="password" data-toggle="password" name="password" class="form-control"
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="remember" type="checkbox" class="icheckbox_flat-green" value="1">
                            <?php echo lang('login_remember_label') ?>
                        </label>
                    </div>
                </div><!-- /.col -->
                <div class="col-xs-4">
                    <input type="submit" class="btn bg-green btn-block" id="loginBtn"
                        value="<?php echo lang('login_submit_btn') ?>" />
                </div><!-- /.col -->
            </div>
            <?php echo form_close();?>
            <!-- Belum Punya akun ?  Daftar <a href="<?= site_url('register');?>"> Disini</a><br/> -->
            <a href="forgot_password" class="a"><?php echo lang('login_forgot_password');?></a><br />
