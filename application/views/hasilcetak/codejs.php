<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "hasilcetak/json", "type": "POST"},
                    columns: [
                         {
                            "data": "id_cetak",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "id_cetak",
                            "orderable": false
                        },{"data": "id_cetak"},{"data": "nik"},{"data": "nama"},{"data": "kec"},{"data": "tgl_cetak"},{"data": "hasil_cetak"},{"data": "status_cetak"},{"data": "jns_blanko"},{"data": "alasan_cetak"},{"data": "hsl_blanko"},{"data": "ket"},{"data": "catatan"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
