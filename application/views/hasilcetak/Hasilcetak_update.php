            ...
            <div class="box-body">
                <form action="<?php echo $action; ?>" method="post">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" style="text-transform: uppercase" name="tgl_cetak"
                            id="tgl_cetak" placeholder="Tgl Cetak" value="<?php echo $tgl_cetak; ?>" />
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="hasil_cetak"
                            ...
                            <option value="<?php echo $hasil_cetak; ?>"><?php echo $hasil_cetak; ?></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="status_cetak"
                            ...
                            <option value="<?php echo $status_cetak; ?>"><?php echo $status_cetak; ?></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="jns_blanko" id="jns_blanko"
                            required>
                            <option value="<?php echo $jns_blanko; ?>"><?php echo $jns_blanko; ?></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="alasan_cetak"
                            ...
                            <option value="<?php echo $alasan_cetak; ?>"><?php echo $alasan_cetak; ?></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="hsl_blanko" id="hsl_blanko"
                            required>
                            <option value="<?php echo $hsl_blanko; ?>"><?php echo $hsl_blanko; ?></option>
