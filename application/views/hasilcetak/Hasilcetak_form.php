      ...
      <div class="box-body">
        <form action="<?php echo $action; ?>" method="post">
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control" style="text-transform: uppercase" name="hasil_cetak" id="hasil_cetak" required>
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control" style="text-transform: uppercase" name="status_cetak" id="status_cetak"
              required>
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control" style="text-transform: uppercase" name="jns_blanko" id="jns_blanko" required>
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control" style="text-transform: uppercase" name="alasan_cetak" id="alasan_cetak"
              required>
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control" style="text-transform: uppercase" name="hsl_blanko" id="hsl_blanko" required>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" style="text-transform: uppercase" name="catatan" id="catatan"
