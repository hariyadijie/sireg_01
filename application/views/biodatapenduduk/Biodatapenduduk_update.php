                ...
                <form action="<?php echo $action; ?>" method="post">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="kecamatan" id="kecamatan"
                            ...
                            <?php foreach($kecamatan2 as $row):?>
                            <option value="<?php echo $row->id_kec;?>" <?=($kecamatan == $row->id_kec)?'selected':'';?>>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="listdesalurah" id="listdesalurah">
                            ...
                            <option value="">Pilih Desa/Kelurahan
                            </option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="pekerjaan" id="pekerjaan"
                            ...
                            <?php foreach($pekerjaan2 as $row):?>
                            <option value="<?= $row->id_pekerjaan;?>"
                                <?=($pekerjaan == $row->id_pekerjaan)?'selected':'';?>><?= $row->pekerjaan;?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="pendidikan" id="pendidikan"
                            ...
                            <option value="<?php echo $row->id_pendidikan;?>"
                                <?=($pendidikan == $row->id_pendidikan)?'selected':'';?>><?php echo $row->pendidikan;?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="golongan_darah"
                            ...
                            <?php foreach($goldarah2 as $row):?>
                            <option value="<?php echo $row->id_golongandarah;?>"
                                <?=($golongan_darah == $row->id_golongandarah)?'selected':'';?>>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="agama" id="agama" required>
                            ...
                            <?php foreach($agama2 as $row):?>
                            <option value="<?php echo $row->id_agama;?>" <?=($agama == $row->id_agama)?'selected':'';?>>
                                <?php echo $row->agama;?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="hubungan_dalam_keluarga"
                            ...
                            <?php foreach($hubkel2 as $row):?>
                            <option value="<?php echo $row->id_hubkel;?>"
                                <?=($hubungan_dalam_keluarga == $row->id_hubkel)?'selected':'';?>>
                                <?php echo $row->hubkeluarga;?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="status_perkawinan"
                            ...
                            <?php foreach($statuskawin2 as $row):?>
                            <option value="<?php echo $row->id_statuskawin;?>"
                                <?=($status_perkawinan == $row->id_statuskawin)?'selected':'';?>>
                                <?php echo $row->statuskawin;?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="pencatatan_perkawinan"
                            ...
                            <?php foreach($pencatatanperkawinan as $row):?>
                            <option value="<?php echo $row->id_pencatatanperkawinan;?>"
                                <?=($pencatatan_perkawinan == $row->id_pencatatanperkawinan)?'selected':'';?>>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" style="text-transform: uppercase" name="disabilitas"
                            ...
                            <?php foreach($disabilitas2 as $row):?>
                            <option value="<?php echo $row->id_disabilitas;?>"
                                <?=($disabilitas == $row->id_disabilitas)?'selected':'';?>>
...
$(document).ready(function() { // Ketika halaman sudah siap (sudah selesai di load)
    ...
    $("#kecamatan").change(function() { // Ketika user mengganti atau memilih data provinsi
        ...
        $.ajax({
            ...
            url: "<?php echo base_url("index.php/biodatapenduduk/listdesalurah2"); ?>", // Isi dengan url/path file php yang dituju
            data: {
