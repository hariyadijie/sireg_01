<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "pencatatan_perkawinan/json", "type": "POST"},
                    columns: [
                         {
                            "data": "id_pencatatanperkawinan",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "id_pencatatanperkawinan",
                            "orderable": false
                        },{"data": "id_pencatatanperkawinan"},{"data": "pencatatan_perkawinan"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
                 ...
                 $("#myform").on('submit', function(e){
                    ...
                    if(rowsel.join(",") == ""){
                        ...
                        var prompt =  alertify.confirm('Apakah anda yakin akan menghapus data tersebut?', 'Apakah anda yakin akan menghapus data tersebut?').set('labels', {ok:'Yakin', cancel:'Batal!'}).set('onok',function(closeEvent){ 
                            $.ajax({
                                url: "pencatatan_perkawinan/deletebulk",
                                type: "post",
