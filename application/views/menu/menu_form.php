    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            ...
            ?>
                        ...
                        <input type="hidden" class="form-control" name="sort" id="sort" placeholder="Sort"
                            value="<?php echo $sort; ?>" />
                    </div>
                    <div class="form-group">
                        <!-- <label for="int">Level <?php echo form_error('level') ?></label> -->
                        <input type="hidden" class="form-control" name="level" id="level" placeholder="Level"
                            value="<?php echo $level; ?>" />
                    </div>
                    <div class="form-group">
                        <label>Parent</label>
                        <select class="selectpicker form-control" name="parent_id" id="parent_id"
                            data-placeholder="Select a Parent" data-live-search="true" style="width: 100%;">
                  ...
                  ?>
                    ...
                    <div class="form-group input-group">
                        ...
                        <span class="input-group-addon" style="padding:0px;border:none">
                            <button class="btn bg-purple btn-flat" data-icon="<?= $icon; ?>" role="iconpicker"
                                data-rows="10" data-cols="10" id="target" style="margin-top:25px;padding: 7px"></button>
                        </span>
                    </div>
            ...
            <input type="text" class="form-control" name="id_menu_type" id="id_menu_type" placeholder="Id Menu Type" value="<?php echo $id_menu_type; ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_menu_type" id="id_menu_type"
                            data-placeholder="Select a Menu Type" style="width: 100%;">
                            <?php 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker" multiple="multiple" data-placeholder="Select a Groups"
                            style="width: 100%;" name="id_groups" id="id_groups" data-live-search="true"
                    ...
                    <a href="<?php echo site_url('cms/menu/side-menu') ?>" class="btn btn-default">Batal</a>
                </form>
            </div>
        </div>
    </div>
